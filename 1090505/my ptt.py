...
class PTTSpider(CrawlSpider):
    ...
    def start_requests(self):
        yield Request(url = 'https://www.ptt.cc/bbs/Gossiping',cookies={'over18':'1'})
    rules = (
    ...
    def parse_item(self,response):
        l = ItemLoader(item=ProperiesItem(),response=response)
        ...
        l.add_xpath('category','//*[@id="main-content"]/div[3]/span[2]/text()',re='^\.[.+\]')
        if len(l.get_collected_values('category')) == 0:
            l.add_xpath('category','//*[@id="main-content"]/div[3]/span[2]/text()',re = '^Re')
